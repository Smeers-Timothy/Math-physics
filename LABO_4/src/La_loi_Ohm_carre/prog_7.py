...
def generate_signaux(delta_t):
    ...
    TEMP_1 = math.fmod(TEMP_1 + delta_t * 2 * math.pi / PERIODE,
                   2 * math.pi)
    TEMP_2 = math.fmod(TEMP_2 + delta_t * 2 * math.pi / PERIODE,
                   2 * math.pi)
    TEMP_3 = math.fmod(TEMP_3 + delta_t * 2 * math.pi / PERIODE,
                   2 * math.pi)
    TEMP_4 = math.fmod(TEMP_4 + delta_t * 2 * math.pi / PERIODE,
                   2 * math.pi)
    ...
    power = voltage * intensity_amp

    return (voltage, intensity, power, 100)
